...
class ProductsMongoRepository {
    constructor(db) {
        this.collection = new db_entity_collection_1.DbEntityCollection(db.collection('products'));
    }
    save(obj) {
...
exports.ProductsMongoRepository = ProductsMongoRepository;
//# sourceMappingURL=products-mogno-repo.js.map