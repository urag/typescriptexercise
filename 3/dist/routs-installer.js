...
class RouteInstaller {
    constructor(app) {
        this.routeProviders = [new rest_controller_routes_factory_1.RestRoutesFactory(new categories_controller_1.CategoriesController(), "categories"), new rest_controller_routes_factory_1.RestRoutesFactory(new products_controller_1.ProductsController(), "products")];
